...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-17 20:44:33 UTC<br>状态：成功</p>
</section>
...
<p>精读：《KV Cache Compression Through the Lens of Transform Coding》（9.0/10）</p>
<p>速读：《Exploring High-Bandwidth Flash for Modern LLM Inference: Opportunities and Challenges》（7.0/10）, 《Nanbeige4.2-3B on Apple Silicon: Fixing Deployment Bugs and Decreasing Looped Transformer Memory Overhead》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="KV Cache Compression Through the Lens of Transform Coding">KV Cache Compression Through the Lens of Transform Coding</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Exploring High-Bandwidth Flash for Modern LLM Inference: Opportunities and Challenges">Exploring High-Bandwidth Flash for Modern LLM Inference: Opportunities and Challenges</span></li><li><span class="dpr-home-dashboard-paper-title" title="Nanbeige4.2-3B on Apple Silicon: Fixing Deployment Bugs and Decreasing Looped Transformer Memory Overhead">Nanbeige4.2-3B on Apple Silicon: Fixing Deployment Bugs and Decreasing Looped Transformer Memory Overhead</span></li></ul>
  </div>
